...
class ClipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clip" do
    assert_difference('Clip.count') do
      post clips_url, params: { clip: { description: @clip.description, link: @clip.link, title: @clip.title } }
    end
  ...
  test "should update clip" do
    patch clip_url(@clip), params: { clip: { description: @clip.description, link: @clip.link, title: @clip.title } }
